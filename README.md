...
```bash
$ git clone https://github.com/workjay/panthpatel-portfolio.git
$ cd panthpatel-portfolio
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/workjay/panthpatel-portfolio/blob/main/LICENSE).
